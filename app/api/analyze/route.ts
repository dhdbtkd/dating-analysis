...
- lovePattern: 연애 패턴 설명 (300자 이내) — "당신은"으로 시작 금지, 상황 묘사형으로 ("관계가 깊어질수록…" 같은 방식)
- coreWound: 핵심 상처/공포 (100자 이내) — 짧고 강하게, 논문 말투 금지
- actionTip: 구체적 행동 지침 3가지 배열 — 추상적 조언 금지, 오늘 당장 할 수 있는 행동으로
- mindset: 마인드셋 전환 문장 (150자 이내) — 한 문장으로, 강렬하게
...
주의사항:
- typeName - 일반적인 유형 설명 금지 — 이 사람의 점수와 대화 내용에서만 도출할 것. 어려운 단어 쓰지말고 알아 들을 수 있게 쓰기.
